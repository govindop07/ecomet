...
const PlaceOrderPage = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t max-w-[90%] md:max-w-[80%] mx-20">
      {/* left side */}
      <div className="flex flex-col gap-4 w-full sm:max-w-[480px]">
        ...
        <input className="border border-gray-300 rounded py-1.5 px-3.5 w-full" type="number" placeholder="Pho"/>
      </div>
